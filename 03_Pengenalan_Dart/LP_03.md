...
1. **Deklarasi Variabel:**
   - `var name = "Danuar";` mendeklarasikan variabel `name` dengan tipe data `String` secara implisit. Nilai yang diberikan adalah `"Danuar"`.
   - `var age = "20";` mendeklarasikan variabel `age` dengan nilai `"20"`. Karena menggunakan `var`, Dart secara otomatis mengenali tipe data dari nilai yang diberikan.
...
3. **Deklarasi Tipe Data Eksplisit:**
   ...
   - `firstName = "Danu";` dan `lastName = "yaa";` mengisi variabel tersebut dengan nilai masing-masing.
